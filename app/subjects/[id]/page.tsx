    ...
    <div className="min-h-screen bg-gradient-to-b from-sky-300 via-sky-200 to-amber-100">
      ...
      <div className="pt-24 pb-12 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Subject Header */}
          <div className="bg-white rounded-3xl shadow-2xl p-6 md:p-12 mb-12 overflow-hidden relative">
            <div
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-start gap-6">
              {/* Icon */}
              <div
                className={`bg-gradient-to-br ${subject.color} rounded-2xl p-5 md:p-8 shadow-lg flex-shrink-0`}
              >
              ...
              <div className="flex-1 w-full">
                ...
                <p className="text-base md:text-xl text-slate-600 mb-6 leading-relaxed">
                  {subject.description}
                </p>

                {/* Stats */}
                <div className="flex flex-wrap items-center gap-4">
                  <div className="bg-purple-100 rounded-xl px-4 py-3 md:px-6 md:py-4">
                  ...
                  <div className="bg-blue-100 rounded-xl px-4 py-3 md:px-6 md:py-4">
                    <p className="text-2xl md:text-3xl font-black text-blue-600">
                      {subject.subCourses.reduce(
                        (sum, c) => sum + c.lessons,
                        0,
                      )}
                    </p>
          ...
          <div>
            ...
            <div className="space-y-4 ">
              {subject.subCourses.map((course, idx) => (
                ...
                >
                  <div className="bg-white rounded-2xl p-4 md:p-6 shadow-lg hover:shadow-2xl transition transform hover:scale-[1.02] border-4 border-slate-200 hover:border-purple-400 cursor-pointer group mb-5">
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <div className="flex items-center gap-3 md:gap-6 flex-1 min-w-0">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <h3 className="text-lg md:text-3xl font-black text-slate-800 mb-2 truncate">
                            {course.name}
                          </h3>
                          <div className="flex flex-wrap items-center gap-2 md:gap-6 text-slate-600">
                            ...
                            <span className="font-bold px-3 py-0.5 bg-slate-200 rounded-full text-xs">
                              {course.difficulty}
                            </span>
                          </div>
                        </div>
                      ...
                      {/* Arrow */}
                      <div className="text-2xl md:text-4xl flex-shrink-0 transition transform group-hover:translate-x-2">
                        →
                      </div>
                    </div>
                  </div>
          ...
          {/* CTA Section */}
          <div className="mt-12 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 rounded-3xl shadow-2xl p-8 md:p-12 text-white text-center">
            <h3 className="text-2xl md:text-3xl font-black mb-4">
              🚀 Ready to Master {subject.name}?
            </h3>
            <p className="text-sm md:text-lg mb-6 opacity-90">
              Choose a course above and start your learning journey with
              AI-powered tutoring, interactive lessons, and real-time feedback.
            </p>
            <Link href="/courses">
              <button className="px-6 py-3 rounded-xl bg-white text-purple-600 font-bold hover:shadow-lg transition">
